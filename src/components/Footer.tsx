          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex gap-4">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-10 h-10 rounded-full flex items-center justify-center bg-white/5 border border-white/10 hover:border-emerald-primary/30 text-gray-400 hover:text-white transition-all duration-300"
              >
          ...
          <div className="flex flex-col gap-4">
            ...
            <form onSubmit={handleSubscribe} className="relative flex">
              <input
                ...
                className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-sm text-white placeholder-gray-500 focus:outline-none focus:border-emerald-primary/60 transition-all duration-300"
                required
              />
              <button
                type="submit"
                className="absolute right-2 top-2 bottom-2 w-8 h-8 rounded-lg bg-emerald-primary flex items-center justify-center text-forest-dark hover:bg-neon-green transition-all cursor-pointer"
              >
